...
static void l_message (const char *pname, const char *msg) {
  if (pname) {
    /* Light Blue for the program name (usually "lua") */
    lua_writestringerror("\x1b[94m%s:\x1b[0m ", pname);
  }
  /* Red for the actual error message */
  lua_writestringerror("\x1b[31m%s\x1b[0m\n", msg);
}
